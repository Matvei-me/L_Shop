(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function r(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(n){if(n.ep)return;n.ep=!0;const a=r(n);fetch(n.href,a)}})();function q(){const t=(window.location.hash.slice(1)||"/").split("?")[0]||"/",o=(t.startsWith("/")?t.slice(1):t).split("/")[0];return o==="cart"?"cart":o==="delivery"?"delivery":o==="auth"?"auth":""}function y(e){e===""?window.location.hash="/":window.location.hash=`/${e}`}function U(e){e(q()),window.addEventListener("hashchange",()=>e(q()))}let E=null;function m(e){E=e}function j(){return`
  ...
  `;const t=e.querySelector("#delivery-form"),r=e.querySelector("#delivery-message");!t||!r||t.addEventListener("submit",async o=>{o.preventDefault();const n=new FormData(t),a=n.get("address")??"",l=n.get("phone")??"",i=n.get("email")??"",s=n.get("payment")??"";try{await k({address:a,phone:l,email:i,payment:s}),r.textContent="Готово, заказ оформили. Корзину почистило.",t.reset(),b(()=>Promise.resolve().then(()=>x),void 0).then(c=>c.refreshCart()),setTimeout(()=>y(""),2e3)}catch(c){r.textContent=c instanceof Error?c.message:"не отправилось"}})}function Z(e){e.innerHTML=`
    <div class="auth-page">
